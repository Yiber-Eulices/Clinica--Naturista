                        ...
                        <div class="card-body">
                            <div class="stat-widget-one">
                                ...
                                <div class="stat-content dib">
                                    <div class="stat-heading">Paciente</div>
                                    ...
                                    %>
                                    <div class="stat-text">Citas Canceladas : <%=citasCanceladas%></div>
                                    <div class="stat-text">Citas Atendidas : <%=citasAtendidas%></div>
                                    <div class="stat-text">Citas por Atender : <%=citasSinAtender%></div>
                                    <div class="stat-text">Total de Citas Agendadas : <%=citasSinAtender+citasAtendidas+citasCanceladas%></div>
                                </div>
                            </div>
                        </div>
                    </div>
